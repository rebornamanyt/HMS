...
public class alogin extends JFrame {
	...
	public alogin() {
		...
		lblNewLabel_1.setBounds(295, 223, 119, 29);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblPassword = new JLabel("Password:");
		lblPassword.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblPassword.setBounds(295, 314, 119, 29);
		contentPane.add(lblPassword);
		
		user = new JTextField();
		user.setFont(new Font("Tahoma", Font.PLAIN, 18));
		user.setBounds(449, 223, 330, 29);
		...
		lblNewLabel_3.setBounds(449, 135, 184, 43);
