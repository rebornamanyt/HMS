...
public class receptionistpanel extends JFrame {
	...
	public receptionistpanel() {
		...
		JLabel lblLoginPortal = new JLabel("Receptionist Panel");
		...
		lblLoginPortal.setFont(new Font("Tahoma", Font.BOLD, 22));
		lblLoginPortal.setBackground(new Color(0, 128, 128));
		lblLoginPortal.setBounds(10, 342, 225, 35);
		...
		JLabel lblNewLabel = new JLabel("Receptionist Panel");
		...
		JLabel lblAdmin = new JLabel("Add New");
		...
		JLabel lblDoctor = new JLabel("Update");
		...
		JLabel lblReceptionist = new JLabel("Delete ");
		...
		JLabel lblViewPatient = new JLabel("View ");
