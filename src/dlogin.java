...
public class dlogin extends JFrame {
	...
	public dlogin() {
		...
		lblNewLabel_1.setBounds(295, 215, 119, 29);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblPassword = new JLabel("Password:");
		lblPassword.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblPassword.setBounds(295, 310, 119, 29);
		contentPane.add(lblPassword);
		
		user = new JTextField();
		user.setFont(new Font("Tahoma", Font.PLAIN, 18));
		user.setBounds(449, 215, 330, 29);
		...
		JLabel lblNewLabel_3 = new JLabel("Doctor Login");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 30));
		lblNewLabel_3.setForeground(new Color(0, 139, 139));
		lblNewLabel_3.setBounds(455, 135, 212, 43);
			...
			try {
				...
				while(rs.next()){
					...
					if((uname.equals(user))&&(upass.equals(pass))){
							...
							dispose();
							JOptionPane.showMessageDialog(null, "Doctor Login Successfull");
					}
				}
				if (count==0){
					reset();
